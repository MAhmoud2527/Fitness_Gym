                ...
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="">Add Coach</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            ...
                            <div class="card-body card-dashboard">
                                <a href="{{url('/coach/create')}}" class="btn btn-primary mb-2 waves-effect waves-light"><i class="feather icon-plus"></i>&nbsp; Add New Coach</a>
                                    ...
                                    <table class="table
                                        ...
                                        @foreach ($data as $key => $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ url('coach/'. $item->id . '/edit')}}" type="button" class="btn bg-gradient-info waves-effect waves-light">Edit</a>
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <form action="{{url('coach/'.$item->id)}}" method="post">
                                                                    @csrf
                                                                    @method('delete')
